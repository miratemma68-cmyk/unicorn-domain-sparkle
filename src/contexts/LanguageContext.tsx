...
const translations = {
  fr: {
    ...
    domain: {
      ...
      ragdollOriginsP2: "Dès le départ, les Ragdolls se distinguaient par leur tempérament calme et leur tendance à se laisser porter, ce qui leur a valu le nom de « Ragdoll », qui signifie « poupée de chiffon » en anglais. Les premiers Ragdolls avaient également des yeux d'un bleu éclatant et un pelage long et soyeux, ce qui les a rapidement rendus populaires.",
      ragdollOriginsP3: "La race a été officiellement reconnue dans les années 1970, lorsque des éleveurs ont commencé à travailler pour stabiliser les caractéristiques de la race. Depuis lors, le Ragdoll est devenu l'une des races de chats les plus prisées dans le monde, apprécié pour sa nature amicale et son amour pour les humains.",
      ragdollOriginsP4: "Aujourd'hui, les Ragdolls sont souvent décrits comme des « chiens dans le corps d'un chat » pour leur fidélité et leur sociabilité. Ils s'intègrent facilement dans la vie de famille et sont connus pour leur douceur avec les enfants et les autres animaux de compagnie.",
      ragdollOriginsP5: "En résumé, le Ragdoll est une race fascinante qui a su conquérir le cœur des amoureux des chats grâce à son histoire unique et à ses qualités exceptionnelles.",
      values: "Nos Valeurs",
      ...
      laurenceCred1: "L'ACACED n°2023/97a0-0b28 délivré par le ministère de l'agriculture le 22/08/2023",
      laurenceCred2: "Certificat de formation professionnelle au métier d'éleveur félin",
      laurenceCred3: "La chatterie est enregistrée au LOOF sous le n° 42612",
      laurenceCred4: "N° BNO 169507",
  ...
  en: {
    ...
    domain: {
      ...
      ragdollOriginsTitle: "Ragdoll, origins",
      ragdollOriginsP1: "The Ragdoll is a cat breed originating from the United States, more precisely from California, in the 1960s. This breed was created by a breeder named Ann Baker, who crossed a long-haired white cat named Josephine with several other breeds, including the Birman, the Persian and the Siamese. Ann Baker's goal was to develop a cat with a docile and affectionate character, as well as an attractive appearance.",
      ragdollOriginsP2: "From the very beginning, Ragdolls were distinguished by their calm temperament and their tendency to go limp when held, which earned them the name 'Ragdoll'. The first Ragdolls also had striking blue eyes and a long, silky coat, which quickly made them popular.",
      ragdollOriginsP3: "The breed was officially recognized in the 1970s, when breeders began working to stabilize its characteristics. Since then, the Ragdoll has become one of the most prized cat breeds in the world, appreciated for its friendly nature and its love for humans.",
      ragdollOriginsP4: "Today, Ragdolls are often described as 'dogs in a cat's body' for their loyalty and sociability. They fit easily into family life and are known for their gentleness with children and other pets.",
      ragdollOriginsP5: "In short, the Ragdoll is a fascinating breed that has won the hearts of cat lovers thanks to its unique history and exceptional qualities.",
      values: "Our Values",
      ...
      laurenceCred1: "ACACED n°2023/97a0-0b28 issued by the French Ministry of Agriculture on 22/08/2023",
      laurenceCred2: "Professional training certificate as a feline breeder",
      laurenceCred3: "The cattery is registered with LOOF under n° 42612",
      laurenceCred4: "BNO n° 169507",
  ...
  es: {
    ...
    domain: {
      ...
      ragdollOriginsTitle: "Ragdoll, orígenes",
      ragdollOriginsP1: "El Ragdoll es una raza de gato originaria de los Estados Unidos, más precisamente de California, en la década de 1960. Esta raza fue creada por una criadora llamada Ann Baker, quien cruzó a una gata blanca de pelo largo, llamada Josephine, con varias otras razas, en particular el Birmano, el Persa y el Siamés. El objetivo de Ann Baker era desarrollar un gato de carácter dócil y cariñoso, así como de apariencia seductora.",
      ragdollOriginsP2: "Desde el principio, los Ragdolls se distinguieron por su temperamento tranquilo y su tendencia a dejarse llevar en brazos, lo que les valió el nombre de «Ragdoll», que significa «muñeca de trapo» en inglés. Los primeros Ragdolls también tenían ojos de un azul brillante y un pelaje largo y sedoso, lo que rápidamente los hizo populares.",
      ragdollOriginsP3: "La raza fue reconocida oficialmente en la década de 1970, cuando los criadores comenzaron a trabajar para estabilizar las características de la raza. Desde entonces, el Ragdoll se ha convertido en una de las razas de gatos más apreciadas del mundo, valorada por su naturaleza amistosa y su amor por los humanos.",
      ragdollOriginsP4: "Hoy en día, los Ragdolls suelen describirse como «perros en el cuerpo de un gato» por su fidelidad y sociabilidad. Se integran fácilmente en la vida familiar y son conocidos por su dulzura con los niños y otras mascotas.",
      ragdollOriginsP5: "En resumen, el Ragdoll es una raza fascinante que ha sabido conquistar el corazón de los amantes de los gatos gracias a su historia única y a sus cualidades excepcionales.",
      ...
      laurenceCred1: "ACACED n°2023/97a0-0b28 expedido por el Ministerio de Agricultura de Francia el 22/08/2023",
      laurenceCred2: "Certificado de formación profesional como criador felino",
      laurenceCred3: "El criadero está registrado en el LOOF con el n° 42612",
      laurenceCred4: "N° BNO 169507",
