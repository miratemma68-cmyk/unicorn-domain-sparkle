          ...
          <div className="space-y-8 text-ivory/90">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="text-center space-y-3">
                <div className="w-16 h-16 mx-auto bg-crimson rounded-full flex items-center justify-center border-2 border-gold">
                  <span className="text-3xl text-gold">1</span>
                </div>
                <h3 className="text-xl font-serif text-gold">Premier Contact</h3>
                <p>Remplissez notre formulaire pour exprimer votre intérêt</p>
              </div>
              
              <div className="text-center space-y-3">
                <div className="w-16 h-16 mx-auto bg-crimson rounded-full flex items-center justify-center border-2 border-gold">
                  <span className="text-3xl text-gold">2</span>
                </div>
                <h3 className="text-xl font-serif text-gold">Rencontre</h3>
                <p>Visitez notre élevage et faites connaissance avec nos licornes</p>
              </div>
              
              <div className="text-center space-y-3">
                <div className="w-16 h-16 mx-auto bg-crimson rounded-full flex items-center justify-center border-2 border-gold">
                  <span className="text-3xl text-gold">3</span>
                </div>
                <h3 className="text-xl font-serif text-gold">Adoption</h3>
                <p>Accueillez votre compagnon avec un suivi personnalisé</p>
              </div>
            </div>
            
            <div className="bg-crimson/20 border border-gold/30 rounded-lg p-6 mt-12">
              <h3 className="text-2xl font-serif text-gold mb-4">Ce que vous recevez</h3>
