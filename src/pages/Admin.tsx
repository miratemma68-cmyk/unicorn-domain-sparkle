      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <Card className="mt-8 tapestry-border bg-card/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4 text-ivory/80">
            ...
            <div>
              <h3 className="font-semibold text-gold mb-2">4. Uploader des photos/vidéos</h3>
              <p className="text-sm">
                Allez dans Cloud → Storage → kitten-media pour uploader des médias, puis ajoutez les références dans kitten_media.
              </p>
            </div>
          </CardContent>
        </Card>
